...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0002_auto_20180603_1029'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='order',
            name='coupon',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='coupons.Coupon', verbose_name='coupon'),
        ),
        migrations.AlterField(
            model_name='order',
            name='created',
